...
public class wipro extends javax.swing.JFrame {
    
    private static final Timer newsTimer = new Timer();
    private static final List<String> stockSymbols = List.of(" WIPRO");
...
//}
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/wipro.jpg"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Lucida Handwriting", 3, 36)); // NOI18N
        jLabel2.setText("WIPRO");
        ...
        jTextArea1.setText("Wipro Limited, headquartered in Bangalore, India, is a leading global information technology, consulting, and business process services company. Founded in 1945, Wipro has evolved into a diverse and innovative organization The company's services encompass IT consulting,");
        ...
        jLabel11.setText("Wipro Ltd.");

        jLabel12.setText("1945");

        jLabel13.setText("Mr. Thierry Delaporte");

        jLabel14.setText("WIPRO");
