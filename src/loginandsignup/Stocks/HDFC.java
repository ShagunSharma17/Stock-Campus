...
public class HDFC extends javax.swing.JFrame {
    ...
    private static final List<String> stockSymbols = List.of("HDFC BANK");
...
//}
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/hdfc.jpg"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Lucida Handwriting", 3, 36)); // NOI18N
        jLabel2.setText("HDFC");
        ...
        jTextArea1.setText(" HDFC is recognized for its strong financial performance, customer-centric approach, and contributions to the growth of the housing and financial sectors in India. It's important to note that the business environment can change, and for the latest and most accurate information");
        ...
        jLabel11.setText("HDFC Bank Limited");

        jLabel12.setText("1994");

        jLabel13.setText("Mr. Sashidhar Jagdishan");

        jLabel14.setText("HDFCBANK");
