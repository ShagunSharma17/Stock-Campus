...
public class SBI extends javax.swing.JFrame {
    ...
    private static final List<String> stockSymbols = List.of("State Bank of India");
...
//}
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/sbi.jpg"))); // NOI18N
        ...
        jTextArea1.setText("State Bank of India (SBI) stands as one of India's largest and oldest public sector banks, playing a pivotal role in the country's banking and financial sector. Established in 1806 as the Bank of Calcutta,State Bank of India (SBI) stands as one of India's largest Bank.");
        ...
        jLabel11.setText("State of India");

        jLabel12.setText("1955");

        jLabel13.setText("Shri. Challa Setty");

        jLabel14.setText("SBIN");
