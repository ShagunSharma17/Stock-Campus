...
public class Nifty extends javax.swing.JFrame {
    
    private static final Timer newsTimer = new Timer();
    private static final List<String> stockSymbols = List.of("Nifty 50");
...
//}
   ...
   private void checkAndGetData() {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/download2.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Lucida Handwriting", 3, 36)); // NOI18N
        jLabel2.setText("NIFTY 50");
