...
public class ITC extends javax.swing.JFrame {
    ...
    private static final List<String> stockSymbols = List.of("ITC");
...
//}
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/itc.jpg"))); // NOI18N
        ...
        jTextArea1.setText("ITC Limited is a diversified conglomerate headquartered in India, operating across various sectors. With a strong presence in the fast-moving consumer goods (FMCG) industry, ITC is a significant player in paperboards and packaging, agribusiness, and information technology.");
        ...
        jLabel11.setText("ITC Limited");

        jLabel12.setText("1910");

        jLabel13.setText("Mr. Sanjiv Puri");

        jLabel14.setText("ITC");
