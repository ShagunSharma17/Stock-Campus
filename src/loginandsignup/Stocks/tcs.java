...
public class tcs extends javax.swing.JFrame {
    ...
    private static final List<String> stockSymbols = List.of("TCS");
...
//}
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/tcs.jpg"))); // NOI18N
        ...
        jTextArea1.setText("Tata Consultancy Services (TCS) is a global IT services and consulting company headquartered in India, recognized as one of the largest and most influential players in the information technology industry. Established in 1968 as a division of the Tata Group.");
        ...
        jLabel11.setText("TCS Ltd.");

        jLabel12.setText("1995");

        jLabel13.setText("Mr. K. Krithivasan");

        jLabel14.setText("TCS");
